...
//                        .put("region", privateBucketSettings.get("region"))
    ...
    private void assertMetadataFileIsEncrypted(String snapshotName) {
        ...
        String endpoint = settings.get("repositories.s3.endpoint");
        String protocol = settings.get("repositories.s3.protocol");
        String region =   settings.get("repositories.s3.region");
        String accessKey = settings.get("cloud.aws.access_key");
        String secretKey = settings.get("cloud.aws.secret_key");
